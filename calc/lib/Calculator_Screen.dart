...
class _CalculatorscreenState extends State<Calculatorscreen> {
 ...
 String number2="";
  ...
  Color getBtnColor(value){
    return [Btn.del,Btn.clr].contains(value)?Colors.blueGrey:[Btn.per,Btn.add,Btn.divide,Btn.multiply,Btn.subtract,Btn.calculate].contains(value)?Colors.orange:Colors.black87;
  }
}